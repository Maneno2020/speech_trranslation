...
#Below is the newly added lines of codes and incase of any error then the line should
# either be commented out or removed completely fronm the codes. And after
# that the commented ;lines of codes should be uncommented
...
#
#     is_luganda = combo1.get() == "Luganda"
#
#     try:
#         output = recognize_speech(temp_audio_file, is_luganda)
#         if output:
#             recognized_text = output.get("text", "Recognition failed")
